...
/**
 * creates GL renderable (blittable) font out of given AWT font.
 * A jPCT texture is created and added to TextureManager on the fly.
 * In contrast with its name, this class can be used for software renderer too.
 *
...
public class GLFont {
	...
	public static final String GERMAN = new String(
			new char[] { '\u00c4', '\u00D6', '\u00DC', '\u00E4', '\u00F6', '\u00FC', '\u00DF' });

	/** French specific characters */
	public static final String FRENCH = new String(new char[] { '\u00C0', '\u00C2', '\u00C6', '\u00C8', '\u00C9',
			'\u00CA', '\u00CB', '\u00CE', '\u00CF', '\u00D4', '\u0152', '\u00D9', '\u00DB', '\u00DC', '\u0178',
			'\u00C7', '\u00E0', '\u00E2', '\u00E6', '\u00E8', '\u00E9', '\u00EA', '\u00EB', '\u00EE', '\u00EF',
			'\u00F4', '\u0153', '\u00F9', '\u00FB', '\u00FC', '\u00FF', '\u00E7' });

	/** Turkish specific characters */
	public static final String TURKISH = new String(new char[] { '\u00e7', '\u00c7', '\u011f', '\u011e', '\u0131',
			'\u0130', '\u00f6', '\u00d6', '\u015f', '\u015e', '\u00fc', '\u00dc' });
	...
	/**
	 * returns cached font or creates a new one caches and returns it. note:
	 * cache mechanism doesnt take alphabet into account.
	 */
	...
	/**
	 * regular font height. note some special characters may not fit into this
	 * height. see {@link FontMetrics} for a discussion
	 */
	...
	/**
	 * creates a GLFont for given awt Font consists of characters in given
	 * alphabet
	 * 
	 * @param font
	 *            the awt font
	 * @param alphabet
	 *            characters of our alphabet
	 */
